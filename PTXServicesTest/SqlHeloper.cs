...
namespace PTXServicesTest
{
    ...
    {
        //public  string connectionString = ConfigurationManager.ConnectionStrings["ConnStringZLservice"].ConnectionString;
        private string _connectionString = ConfigurationManager.ConnectionStrings["PTXConn"].ConnectionString;
        ...
        internal int ExecuteNonQuery(CommandType text, string v, string strconnection)
        {
        ...
        private void PrepareCommand(DbCommand cmd, DbConnection conn, DbTransaction trans, CommandType cmdType, string cmdText,
        ...
        /// <param name="commandParameters">使用到的參數集合</param>
        /// <returns>受影響的資料筆數</returns>
        public int ExecuteNonQueryText(string cmdText, params DbParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">使用到的參數集合</param>
        /// <returns>回傳第一行第一列的資料，型別不確定</returns>
        public object ExecuteScalarText(string cmdText, params DbParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">使用到的參數集合</param>
        /// <returns>回傳DbDataReader指標</returns>
        public DbDataReader ExecuteReaderText(string cmdText, params DbParameter[] commandParameters)
        {
        ...
        public void ExecuteSqlTran(Dictionary<string, DbParameter[]> sqlStringList)
        {
        ...
        public void ExecuteSqlTran(string connectionString, CommandType cmdType, Dictionary<string, DbParameter[]> sqlStringList)
        {
        ...
        public DataTable GetDataTable(string connecttionString, CommandType cmdTye, string cmdText, params DbParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">使用到的參數集合</param>
        /// <returns>取得Select指令回傳的結果集，型別DataTable</returns>
        public DataTable GetDataTable(CommandType cmdTye, string cmdText, params DbParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameters">使用到的參數集合</param>
        /// <returns>取得Select指令回傳的結果集，型別DataTable</returns>
        public DataTable GetDataTableText(string cmdText, params DbParameter[] commandParameters)
        {
